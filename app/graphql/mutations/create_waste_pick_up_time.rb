...
module Mutations
  class CreateWastePickUpTime < BaseMutation
    ...
    argument :waste_location_type, Types::WasteLocationTypeInput, required: false,
             as: :waste_location_type_attributes,
             prepare: lambda { |address, _ctx|
                        address.to_h
                      }

    field :waste_pick_up_time, Types::WastePickUpTimeType, null: true

    type Types::WastePickUpTimeType
