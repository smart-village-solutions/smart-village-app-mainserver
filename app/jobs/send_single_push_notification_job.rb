...
class SendSinglePushNotificationJob < ApplicationJob
  ...
  def send_single_push_notification(device_token, message_options, municipality_id)
  ...
  def perform(device_token, message_options, municipality_id)
    send_single_push_notification(device_token, message_options, municipality_id)
  end

  def self.perform(device_token, message_options, municipality_id)
    send_single_push_notification(device_token, message_options, municipality_id)
  end
