...
class EventRecord < ApplicationRecord
  ...
  has_many :announcements, -> { includes(Resolvers::ShoutsSearch::ANNOUNCEMENT_INCLUDES).where(generic_itemable_type: "EventRecord", generic_type: GenericItem::GENERIC_TYPES[:announcement]) },
