namespace :setup do
  ...
  task accounts: :environment do
    ...
    admin.save
    doorkeeper_app = Doorkeeper::Application.new name: "Administrator", redirect_uri: "urn:ietf:wg:oauth:2.0:oob"
    doorkeeper_app.owner = admin
    doorkeeper_app.save
    puts "Admin created with id: #{admin.id}"

    # Create Mobile App
    app_data_provider = DataProvider.create(name: "MobileApp", description: "", logo: create_web_url)
    ...
    app_user.save
    doorkeeper_app = Doorkeeper::Application.new name: "MobileApp", redirect_uri: "urn:ietf:wg:oauth:2.0:oob"
