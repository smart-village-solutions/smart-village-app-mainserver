...
ActiveRecord::Schema.define(version: 2023_09_18_130709) do
  ...
  create_table "generic_item_messages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "notification_push_device_assignments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "notification_pushes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
